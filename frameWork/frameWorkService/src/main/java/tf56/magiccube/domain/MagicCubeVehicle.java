package tf56.magiccube.domain;

import java.util.Date;
import java.io.Serializable;

/**
 * ClassName:MagicCubeVehicle 运力魔方_车辆基本信息表
 *
 * @author tool
 * @version 1.0
 * @since v1.0
 ...
 */
public class MagicCubeVehicle implements Serializable {
	 ...
	 *  运力魔方车辆ID
	 */
	private Long magicCubeVehicleId;
	...
	public void setMagicCubeVehicleId(Long magicCubeVehicleId) {
		this.magicCubeVehicleId = magicCubeVehicleId;
	}

	public Long getMagicCubeVehicleId() {
		return magicCubeVehicleId;
	}
